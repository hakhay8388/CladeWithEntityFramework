...
using Sys.Web.nWebGraph.nWebApiGraph.nCommandGraph.nCommands.nMessageResultCommand;
...
namespace Sys.Web.nWebGraph.nWebApiGraph.nActionGraph.nActions.nShowMessageAction
{
    public class cMessageResultReceiver<T> : cCoreObject,  IMessageResultReceiver
    {
        ...
        public cMessageResultReceiver(cApp _App, cBaseWebGraph _WebGraph, IController _Controller, Action<cBaseCommand, IController, EMessageButton, T> _Action)
            :base(_App)
        {
            WebGraph = _WebGraph;
