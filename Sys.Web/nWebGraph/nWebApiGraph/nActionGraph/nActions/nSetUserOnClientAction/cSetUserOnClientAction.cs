...
namespace Sys.Web.nWebGraph.nWebApiGraph.nActionGraph.nActions.nSetUserOnClientAction
{
    public class cSetUserOnClientAction : cBaseAction, IActionWithoutProps
    {
        public cSetUserOnClientAction(cApp _App, cBaseWebGraph _WebGraph)
           : base(_App, _WebGraph, EActionType.SetUserOnClient)
        {
