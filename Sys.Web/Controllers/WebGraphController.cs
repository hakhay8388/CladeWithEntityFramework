...
namespace Sys.Web.Controllers
{
    ...
    public class WebGraphController : cBaseController
    {
        ...
        public WebGraphController(cApp _App, cBaseWebGraph _WebGraph, IDataService _DataService, IHubContext<SignalRHub> _SignalHub)
        ...
        public JsonResult WebApi()
        {
            ...
            try
            {
                WebGraph.SysActionGraph.SetServerDateTimeAction.Action(this, new cSetServerDateTimeProps() { ServerDate = App.Handlers.DateTimeHandler.Now });

                WebGraph.SysNotificationManager.StartNotificationBroadCaster(this);
