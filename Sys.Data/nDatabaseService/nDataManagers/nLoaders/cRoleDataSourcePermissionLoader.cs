...
namespace Sys.Data.nDataService.nDataManagers.nLoaders
{
	...
	public class cRoleDataSourcePermissionLoader : cBaseDataLoader
    {
        ...
        public cRoleDataSourcePermissionLoader(cApp _App, IDataService _DataService, IFileDateService _FileDataService, cChecksumDataManager _ChecksumDataManager
