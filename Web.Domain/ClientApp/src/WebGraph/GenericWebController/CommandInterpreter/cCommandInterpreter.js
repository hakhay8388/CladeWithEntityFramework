import { cObjType, DebugAlert, Class, Interface, Abstract, ObjectTypes, GlobalEval, JSTypeOperator } from "../../GenericCoreGraph/ClassFramework/Class"
            ...
            if (this.CommandList != null) {
                ...
                for (var i = 0; i < __Count; i++) {
                    ...
                    eval("var __TempFunction = function() { " +
                        "delete module.exports.c" + __CoreName + "Command;" +
                        "delete EThis." + __CoreName + "Command;" +
                        "}()");

                    var __Item = CommandIDs.CommandIDList.GetItem(i);
                    if (JSTypeOperator.IsDefined(ObjectTypes["c" + __CoreName + "Command"])) delete ObjectTypes["c" + __CoreName + "Command"];
                    if (JSTypeOperator.IsDefined(ObjectTypes["I" + __CoreName + "CommandReceiver"])) delete ObjectTypes["I" + __CoreName + "CommandReceiver"];
                    if (JSTypeOperator.IsDefined(ObjectTypes["c" + __CoreName + "CommandConnector"])) delete ObjectTypes["c" + __CoreName + "CommandConnector"];


                    eval("delete module.exports.I" + __CoreName + "CommandReceiver;");
                    eval("delete ECommandInterfaces.I" + __CoreName + "CommandReceiver;");

                    eval("delete module.exports.c" + __CoreName + "Command;");
