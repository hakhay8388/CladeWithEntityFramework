...
var TLanguagePage = Class(TObject,
    {
        ObjectType: ObjectTypes.Get("TLanguagePage"),
        constructor: function (_Props) {
            TLanguagePage.BaseObject.constructor.call(this, _Props);
            this.state = {
                ...this.state,
            };
        },
        ...
        Destroy: function () {
            TLanguagePage.BaseObject.Destroy.call(this);
        }
        ,
        render() {
...
export default withStyles(GlobalStyles)(TLanguagePage);
